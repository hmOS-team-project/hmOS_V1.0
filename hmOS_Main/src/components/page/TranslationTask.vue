        ...
        <el-row :gutter="18" style="margin: 30px 120px">
            <el-col :span="16">
                ...
                >
                    ...
                    <el-row :gutter="20" style="margin-left: 15px">
                        <el-col :span="14" style="padding: 0 5px">
                            ...
                            >
                                <el-form-item label="Name">
                                    <el-col :span="20">
                                        <input type="text" class="input1" id="input_name" v-model="input1" autocomplete="off" />
                                    </el-col>
                                </el-form-item>
                                <el-form-item label="Interaction rounds Limit" label-width="260px">
                                    <el-col :span="20">
                                        <input
                                            type="text"
                                            class="input1"
                                            id="input_rounds_limit"
                                            v-model="input2"
                                            autocomplete="off"
                                            style="width: 170px; margin-right: 10px"
                                        />
                                        <span style="font-size: 18px; color: #03e9f4; margin-right: 10px; font-weight: 400">Time (s)</span>
                                        </el-col>
                                </el-form-item>
                                ...
                                <el-form-item label="Description">
                                    <el-col :span="20">
                                        <textarea
                                            ...
                                            v-model="input5"
                                            style="width: 275px; height: 240px"
                                            autocomplete="off"
                                        ></textarea>
                                    </el-col>
                                </el-form-item>
                        ...
                        <el-col :span="9" style=" background-color:rgba(3, 26, 37, 0.3);box-shadow: 0px 0px 10px #837979;border-radius:10px; height: 500px">
                            <el-form ref="form" :model="form" label-width="210px" class="form-item-name">
                                <el-form-item label="Resource Allocation"> </el-form-item>
                            </el-form>
                            <div class="resourcenum">
                                <div style="margin-left: 10px">
                                    <el-radio class="el-radio" v-model="radio" :label="true">Default</el-radio>
                                    <el-radio class="el-radio" v-model="radio" :label="false" @click="changestatus()"
                                        >User Defined</el-radio
                                    >
                                </div>
                                ...
                                <div class="resource-box">
                                    <img
                                        ...
                                        style="display: block; width: 60px; height: 60px; margin: 7px"
                                    />
            ...
            <el-col :span="8">
                ...
                >
                    ...
                    <div class="net-box">
                        ...
                        <div class="net-select">
                            <el-radio-group v-model="structure" :disabled="radio1">
                                <td>
                                    <el-radio :label="1">lightweigh-HMPT</el-radio>
                                </td>
                                <tr></tr>
                                <td>
                                    <el-radio :label="2">HMPT</el-radio>
                                </td>
                                <tr></tr>
                    ...
                    <div class="net-box">
                        <div class="net-name">Threshold for Maximum Output Probability</div>
                        <div class="net-select">
                            <el-radio-group v-model="backbone" :disabled="radio1">
                                ...
                                <td>
                                    <el-radio :label="2">0.8</el-radio>
                                </td>
                                <tr></tr>
                                <td>
                                    <el-radio :label="3">0.6</el-radio>
                                </td>
                                <td>
                                    <el-radio :label="4">0.4</el-radio>
                                </td>
                                <tr></tr>
                    ...
                    <div class="net-box">
                        <div class="net-name">Similarity Threshold for Encoder Output</div>
                        <div class="net-select">
                            <el-radio-group v-model="extensionModule" :disabled="radio1">
                                <td>
                                    <el-radio :label="1">0.99&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</el-radio>
                                </td>
                                <td>
                                    <el-radio :label="2">0.8</el-radio>
                                </td>
