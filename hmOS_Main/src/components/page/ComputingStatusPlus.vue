    ...
    <div>
        ...
        <el-row :gutter="24" style="margin: 30px 60px">
            <el-col :span="24">
                <el-card
                    shadow="hover"
                    style="height: 630px; padding: 5px; background-color: rgba(5, 53, 77, 0.7); border: 0"
                ...
                >
                    ...
                    <div class="divider div-transparent"></div>
                      <el-row :gutter="20">
            <el-col :span="12">
                <el-card shadow="hover" style="height: 285px; padding: 5px; background-color: rgba(5, 53, 77, 0.7); border: 0" 
                >
            ...
            <el-col :span="12">
                <el-card shadow="hover" style="height: 285px; padding: 5px; background-color: rgba(5, 53, 77, 0.7); border: 0" class="mgb20"
